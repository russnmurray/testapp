...
// +++begin+++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// ++++++++++++++++ acoble - added on 24 July 2015 +++++++++++++++++
// ++ added eventType argument, which passes the event type to the 
// ++ bind function provided for the emitterListener.
// ++ Anything not aware of this extra arg will be unaffected and
// ++ will just see the unwrapped function to wrap/preview as before.
// ++ Our code that knows about the second arg can see the eventType.
// ++ This is better than pushing on the front of the args,
// ++ because we don't have to worry about breaking things if it
// ++ doesn't get popped off the front of the args.
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
function _wrap(unwrapped, visit, eventType) {
  if (!unwrapped) return;

  var wrapped = unwrapped;
  if (typeof unwrapped === 'function') {
// ++ added eventType in line below
    wrapped = visit(unwrapped,eventType);
// ++
  }
...
// ++ added eventType in line below
      wrapped[i] = visit(unwrapped[i],eventType);
// ++
    }
  }
  return wrapped;
...
// +++begin+++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// ++++++++++++++++ acoble - added on 24 July 2015 +++++++++++++++++
// ++ see above. need to pass eventType to _wrap
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
