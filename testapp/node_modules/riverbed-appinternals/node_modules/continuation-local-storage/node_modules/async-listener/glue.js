...
// ++ For our event-loop handling instrumentation, we want to know
// ++ The original name of the function before it got wrapped by
// ++ asyncListener.
// ++ NOTE: 'onread' seems to be something internal to either
// ++ async listener or the event loop and the user probably doesn't
// ++ want/expect to see it.
// ++ TODO: we should check up on filtering out 'onread' though.
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

// ++ added line below
      this.__originalname = ((original.name && original.name != 'onread')? original.name : '');
// ++
